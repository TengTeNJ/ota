...
class _NtrpTestControllerState extends State<NtrpTestController> {
  ...
  int volleyNumberOfShots = 0; // 截击的有效拍数
  ...
  final NtrpTaskMap = {
    /// 正手
    1: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    2: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    3: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    4: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    5: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    6: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    7: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    8: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    9: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    10: () => controlRobotMove(0, 0, 13, 1, 15, 15, 40, 120, 175),
    /// 反手
    11: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    12: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    13: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    14: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    15: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    16: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    17: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    18: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    19: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    20: () => controlRobotMove(0, 0, -13, 1, 15, 15, 40, 120, 175),
    /// 截击球
    21: () => controlRobotMove(-60, 0, 0, 1, 16, 12, 40, 90, 175),
    22: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    23: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    24: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    25: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    26: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    27: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    28: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    29: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    30: () => controlRobotMove(0, 0, 0, 1, 16, 12, 40, 90, 175),
    // 向前走60 不发球
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 2000), () {
      var model = NtrpDataModel(longRally: 5, forehand: 5, backhand: 8, volley: 9,isWinner: false);
      Navigator.push(
        context,
 ...
 void gotoEndPage() {
   ...
   var model = NtrpDataModel(longRally: 5, forehand: forehandNumberOfShots,

...
class _NtrpTestControllerState extends State<NtrpTestController> {
  ...
  final NtrpTaskMap = {
    ...
    26: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    27: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    28: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    29: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    30: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
  ...
  void gotoEndPage() {
    ...
    double foreaveragSpeed = rightcount ==0 ? 0 :  (rightSum / rightcount);

    double backSum = backhandSpeeds.fold(
        0.0, (previousValue, element) => previousValue + element);
    int backcount = backhandSpeeds.length;
    double backaveragSpeed = backcount ==0 ? 0 :  (backSum / backcount);

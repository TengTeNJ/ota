...
class _NtrpIntegrateTestControllerState
  ...
  final NtrpIntegrateTaskMap = {
    /// 正手
    1: () => controlRobotMove(300, 0, 13, 1,7, 8,40, 130, 175),
    2: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    3: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    4: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    5: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    6: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    7: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    8: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    9: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    10: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),

    /// 反手
    11: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    12: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    13: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    14: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    15: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    16: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    17: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    18: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    19: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    20: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),

    ///  移动打靶30 个球 （5正手  5中间 5反手  5正手  5中间 5反手）
    // 正手
    21: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    22: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    23: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    24: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    25: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    // 中间
    26: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    27: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    28: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    29: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    30: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),

    // 反手
    31: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    32: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    33: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    34: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    35: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),

    // 正手
    36: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    37: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    38: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    39: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),
    40: () => controlRobotMove(0, 0, 13, 1,7, 8,40, 130, 175),

    // 中间
    41: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    42: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    43: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    44: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),
    45: () => controlRobotMove(0, 0, 0, 1,7, 8,40, 130, 175),

    // 反手
    46: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    47: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    48: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    49: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),
    50: () => controlRobotMove(0, 0, -13, 1,7, 8,40, 130, 175),

...
class _NtrpPressureTestControllerState extends State<NtrpPressureTestController> {
  ...
  final NtrpPressureTaskMap = {
    1: () => controlRobotMove(300, 0, 20, 1,9,8,40, 130,150),
    2: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    3: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    4: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    5: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    6: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    7: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    8: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    9: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    10: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),

    11: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    12: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    13: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    14: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    15: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    16: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    17: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    18: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    19: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    20: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),

    21: () => controlRobotMove(0, 0, -20, 0,9,8,40, 130,150),

    22: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    23: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    24: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    25: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    26: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    27: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),
    28: () => controlRobotMove(0, 0, 20, 1,9,8,40, 130,150),
    29: () => controlRobotMove(0, 0, -20, 1,9,8,40, 130,150),

...
import 'package:ota/controllers/step/mode_step2_page.dart';
import 'package:ota/controllers/step/overhead_volley_controller.dart';
                ...
                children: [
                  GestureDetector(
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ModeStep2Page()), // 目标页面
                    );
                  },)
                ],
              ),
                ...
                children: [
                  GestureDetector(
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => OverheadVolleyController()), // 截击凌空
                    );
                  },)
                ],
              ),
                ...
                children: [
                  GestureDetector(
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ParamSettingController()), // 参数设置页面
                    );
                  },)
                ],
              ),

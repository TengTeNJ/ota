...
class ForeAndBackPage extends StatefulWidget {
  const ForeAndBackPage({super.key});

  @override
  State<ForeAndBackPage> createState() => _ForeAndBackPageState();
}

class _ForeAndBackPageState extends State<ForeAndBackPage> {
